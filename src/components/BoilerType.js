...
class BoilerType extends Component {
  ...
  handleEditButton = () => this.props.activateEditButton(this.props.boilerType.id)
  ...
  render() {
    ...
    return(
      <tr>
        ...
        <td>
          <button onClick={this.handleEditButton}><img src="images/pencil.png" alt="Edit icon"></img></button>
